      ...
      <ul className="mt-8 grid gap-4 md:grid-cols-2">
        <li className="border-l-2 border-cyan-400 bg-slate-900/60 p-5">
          ...
          <p className="mt-3 text-sm leading-relaxed text-slate-400">
            I connect the work from early opportunity and architecture through production
            release, keeping technical decisions practical and outcomes in view.
          </p>
        </li>
        <li className="border-l-2 border-fuchsia-400 bg-slate-900/60 p-5">
          ...
          <p className="mt-3 text-sm leading-relaxed text-slate-400">
            I help teams use AI-assisted workflows, modern coding standards, and CI/CD
            automation to spend more time on the decisions that need people.
          </p>
        </li>
        <li className="border-l-2 border-violet-400 bg-slate-900/60 p-5">
          <h3 className="text-lg font-semibold text-slate-100">
            Agile that moves work forward
          </h3>
          <p className="mt-3 text-sm leading-relaxed text-slate-400">
            I facilitate planning and alignment across client stakeholders, UX partners,
            and engineering teams so good ideas become shippable work.
          </p>
        </li>
        <li className="border-l-2 border-amber-400 bg-slate-900/60 p-5">
          ...
          <p className="mt-3 text-sm leading-relaxed text-slate-400">
            From healthcare and payments to public-sector software, I focus on reliable
            services, thoughtful user experiences, and the infrastructure behind both.
          </p>
        </li>
      </ul>
    </section>
